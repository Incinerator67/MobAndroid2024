...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("These values were passed from previous screen" + "transmittedString" + transmittedString + "transmittedInt" + transmittedInt + "transmittedBoolean" + transmittedBoolean);
    }
}